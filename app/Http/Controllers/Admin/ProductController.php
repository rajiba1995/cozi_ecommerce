...
class ProductController extends Controller
{
    ...
    public function exportAll(Request $request)
    {
        ...
        if (count($data) > 0) {
            ...
            // Set column headers
            $fields = array('SR', 'NAME', 'STYLE NUMBER',  'CATEGORY', 'COLOR', 'SIZE', 'PRICE', 'SKU CODE');
